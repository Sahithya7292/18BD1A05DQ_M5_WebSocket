...
<body>
	<div class="container">
		<label style="margin-top:30px;">Notifications - An AMBULANCE is in need - EMERGENCY</label>
	...
	<script>
		...
		websocket.onmessage=function processMessage(message){
			...
			if(jsonData.message!=null)
			{
				...
				row.innerHTML="<td>"+details[0]+"</td><td>Requires an Ambulance</td><td>"+details[1]+"</td>";
