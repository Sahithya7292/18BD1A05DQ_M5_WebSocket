...
<body>
	<div class="container">
		<label style="margin-top:30px;">You Will be Notified when a patient requires an Ambulance</label>
	...
	<script>
		var websocket=new WebSocket("ws://localhost:7007/WebSocketT/VitalCheckEndPoint");
